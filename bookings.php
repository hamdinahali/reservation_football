...
<section class="bookings">
   ...
   <div class="box">
      ...
      <p>date_m : <span><?= $fetch_booking['date_m']; ?></span></p>
      <p>time de match : <span><?= $fetch_booking['time_m']; ?></span></p>
      <p>stadium : <span><?= $fetch_booking['stadium']; ?></span></p>
      <p>players : <span><?= $fetch_booking['players']; ?></span></p>
      <p>out_players : <span><?= $fetch_booking['out_players']; ?></span></p>
      <p>book id : <span><?= $fetch_booking['booking_id']; ?></span></p>
